...
class TimeFoldPage extends StatefulWidget {
  const TimeFoldPage({super.key});

  @override
  _TimeFoldPageState createState() => _TimeFoldPageState();
}

class _TimeFoldPageState extends State<TimeFoldPage> {
